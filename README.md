...
- **[writing-great-agentsmd](writing-great-agentsmd/SKILL.md)** — Write, audit, or slim down AGENTS.md / CLAUDE.md files using progressive disclosure. Use when the user wants to create an AGENTS.md, refactor a bloated one, review agent instructions, or asks why their coding agent ignores or misreads project rules.
